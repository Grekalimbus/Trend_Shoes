    ...
    <div className={styles.wrapp}>
      <div className={styles.flexWrap}>
        ...
        <div className={styles.title}>
          ...
          <p className={styles.smalTitle}>
            Мы рады, что ты выбрал наш магазин. Здесь ты можешь найти брендовую
            обувь разных фирм.
          </p>
          <p className={styles.smalTitle}>
          ...
          <p className={styles.smalTitle}>
            Если ты хочешь посмотреть ассортимент товара, нажми на "Перейти в
            магазин"
          </p>
          <p className={styles.smalTitle}>
            ...
            годах она все чаще изготавливается из резины, пластмассы и других
